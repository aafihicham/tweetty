...
<div class="w-[350px] text-white pl-20 py-4 h-auto">
    <!--left menu-->
...
<div class="flex items-center">
  <div>
    <img class="inline-block h-10 w-10 rounded-full" src="https://assets.weforum.org/article/image/large_-ytU8aFc7NXOVyhZ2HjKvs2CDIRFPYxBqgtKIJd9V-s.png" alt="" />
  </div>
  <div class="ml-3">
