...
<div class="h-auto">
    ...
    <div class="relative text-gray-300 w-80 p-5 pb-0 mr-16">
        ...
        <input type="search" name="search" placeholder="Search Twitter" class="bg-blue-800 h-10 px-10 pr-5 w-full text-sm focus:outline-none bg-purple-white shadow rounded border-0">
    ...
    <div class="max-w-sm rounded-lg bg-blue-800 overflow-hidden shadow-lg m-4 mr-20">
        ...
        <div class="flex">
            <div class="flex-1">
                ...
                <h2 class="px-4 ml-2 w-48 font-bold text-white">#HI-TECH-Fashion</h2>
        ...
        <div class="flex flex-shrink-0">
            <div class="flex-1 ">
                <div class="flex items-center w-48">
                    <div>
                      <img class="inline-block h-10 w-10 rounded-full ml-4 mt-2" src="https://assets.weforum.org/article/image/large_-ytU8aFc7NXOVyhZ2HjKvs2CDIRFPYxBqgtKIJd9V-s.png" alt="" />
                    </div>
                    <div class="ml-3 mt-3">
